                    ...
                    @auth
                        @if (auth()->user()->role !== 1)
                            <div class="flex items-center gap-2">
                                ...
                                <img id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" src="{{asset('images/img12.JPG')}}" alt="" class="cursor-pointer w-[30px] rounded-full hover:border-yellow-400 hover:border-2">
