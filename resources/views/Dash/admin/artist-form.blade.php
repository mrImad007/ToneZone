    ...
    <div class="w-4/6 bg-gray-700/70 p-6 mx-auto mt-4">
        <form action="/admin/storeArtist" method="POST" enctype="multipart/form-data" class="w-full">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="artist_name" value="{{old('artist_name')}}" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-yellow-600 appearance-none focus:outline-none focus:ring-0 focus:border-yellow-400 peer" placeholder=""/>
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="city" value="{{old('city')}}" id="floating_password" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-yellow-600 appearance-none focus:outline-none focus:ring-0 focus:border-yellow-400 peer" placeholder=" "/>
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="date" name="age" value="{{old('age')}}" id="floating_first_name" class="block py-2.5 px-0 w-full text-sm text-gray-400 bg-transparent border-0 border-b-2 border-yellow-600 appearance-none  focus:outline-none focus:ring-0 focus:border-yellow-400 peer" placeholder=" " />
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="file" name="image" value="{{old('image')}}" id="floating_last_name" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-yellow-600 appearance-none focus:outline-none focus:ring-0 focus:border-yellow-400 peer" placeholder=" " />
